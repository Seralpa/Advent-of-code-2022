...
l = nx.shortest_path_length(g, (0, 1, 0), (rows - 1, cols - 2)) - 1
l += nx.shortest_path_length(g, (rows - 1, cols - 2, l % lcm), (0, 1)) - 1
l += nx.shortest_path_length(g, (0, 1, l % lcm), (rows - 1, cols - 2)) - 1
print(l)